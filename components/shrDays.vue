<template>
    <div>
        <div class="ring-2 ring-custom-purple px-27 lg:px-33 py-11c relative left-1 top-1 bg-custom-pink">
            <p id="border-purple" class="text-custom-purple text-2xl">{{day}}</p>
        </div>
        <div class="ring-2 ring-custom-purple px-27 lg:px-33 py-11c bg-custom-pink z-10 relative -top-54">
            <p id="border-purple" class="text-custom-purple text-2xl">{{day}}</p>
        </div>
        <div class="flex flex-col justify-center items-center relative -top-48">
            <div v-if="open!==''" class="border-l-custom border-custom-black h-50 lg:h-75"></div>
